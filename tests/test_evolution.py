...
def test_evolution_diagnostics_and_patching(tmp_path):
    ...
    failures = engine.diagnose_workspace([str(bad_python_file)], test_path="invalid_test_dir")
...
def test_evolution_cli_integration(tmp_path):
    ...
    result = runner.invoke(app, [
        "evolve",
        "--seed", str(seed_file),
        "--tests", "invalid_tests_dir" # skip tests
    ])
